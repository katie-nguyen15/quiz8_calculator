...
def main():
    ...
    txtDisplay = Entry(cal, font=("ariel", fontSize + 5),
                       textvariable=text_input,
                       bd=15, insertwidth=3, bg="powder blue",
                       justify='right').grid(columnspan=5)
    # 7, 8 ,9
    btn7 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="7",
                  command=lambda: btnClick(7)).grid(row=1, column=0)
    btn8 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="8",
                  command=lambda: btnClick(8)).grid(row=1, column=1)
    btn9 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="9",
                  command=lambda: btnClick(9)).grid(row=1, column=2)
    # 4, 5, 6
    btn4 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="4",
                  command=lambda: btnClick(4)).grid(row=2, column=0)
    btn5 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="5",
                  command=lambda: btnClick(5)).grid(row=2, column=1)
    btn6 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="6",
                  command=lambda: btnClick(6)).grid(row=2, column=2)
    # 1, 2, 3
    btn1 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="1",
                  command=lambda: btnClick(1)).grid(row=3, column=0)
    btn2 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="2",
                  command=lambda: btnClick(2)).grid(row=3, column=1)
    btn3 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="3",
                  command=lambda: btnClick(3)).grid(row=3, column=2)
    # C, 0, =
    btn1Clear = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                       bd=8, fg="black", text="C",
                       command=btnClearDisplay).grid(row=4, column=0)
    btn0 = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                  bd=8, fg="black", text="0",
                  command=lambda: btnClick(0)).grid(row=4, column=1)
    btnEquals = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                       bd=8, fg="black", text="=",
                       command=btnEqualsInput).grid(row=4, column=2)
    # + , - , *, /
    btnAdd = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                    bd=8, fg="black", text="+",
                    command=lambda: btnClick("+")).grid(row=1, column=3)
    btnSub = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                    bd=8, fg="black", text="-",
                    command=lambda: btnClick("-")).grid(row=2, column=3)
    btnMul = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                    bd=8, fg="black", text="*",
                    command=lambda: btnClick("*")).grid(row=3, column=3)
    btnDiv = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                    bd=8, fg="black", text="/",
                    command=lambda: btnClick("/")).grid(row=4, column=3)

    # sqrt, ^, ^2, back
    btnSqrt = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                     bd=8, fg="black", text="√",
                     command=btnSquareRoot).grid(row=5, column=0)
    btnPow = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                    bd=8, fg="black", text="^",
                    command=lambda: btnClick("**")).grid(row=5, column=1)
    btnSquare = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                       bd=8, fg="black", text="^2",
                       command=btnSquared).grid(row=5, column=2)
    btnDel = Button(cal, font=("ariel", fontSize), padx=16, pady=16,
                    bd=8, fg="black", text="↵",
                    command=btnDelete).grid(row=5, column=3)
    """
    # enlarge, shrink
    btnEnlarge = Button(cal, font=("ariel", fontSize), padx=xPad * 2,
                        pady=yPad, bd=8, fg="black", text="enlarge",
                        command=enlarge).grid(row=6, column=0, columnspan=2)
    btnShrink = Button(cal, font=("ariel", fontSize), padx=xPad * 2, pady=yPad,
